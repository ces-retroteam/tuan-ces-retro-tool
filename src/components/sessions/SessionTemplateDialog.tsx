        ...
        <div className="flex-1 overflow-hidden">
          <Tabs defaultValue="general" className="h-full flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto">
              <TabsContent value="general" className={`${isMobile ? 'p-4' : 'p-6'} space-y-6 mt-0`}>
    ...
    return (
      <>
        ...
        <Sheet open={open} onOpenChange={onOpenChange}>
          <SheetContent side="bottom" className="h-[100vh] max-h-none p-0 flex flex-col">
            <SheetHeader className="p-4 border-b shrink-0">
              <div className="flex items-center justify-between">
                <SheetTitle className="text-xl font-semibold text-textPrimary">Create Session</SheetTitle>
                <button
