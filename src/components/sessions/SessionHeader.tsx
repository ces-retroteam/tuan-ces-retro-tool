...
export function SessionHeader({
  ...
  return (
    <header className="w-full flex justify-center border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
      <div className="w-full max-w-7xl flex items-center justify-between py-3 px-4 md:px-8" style={{ width: "90%" }}>
        {/* Logo & name */}
        ...
        <div className="flex items-center gap-3 shrink-0">
          <div className="flex flex-col text-right max-w-[160px]">
            <span className="font-semibold text-sm text-gray-900 dark:text-gray-100 truncate">{currentUser.name}</span>
